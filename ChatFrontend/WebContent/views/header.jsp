  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li ><a href="#!Home">Home</a></li>	
				...
				<li ng-hide="currentUser==undefined" ng-show="currentUser.role=='ROLE_USER' ||currentUser.role=='ROLE_ADMIN'"><a href="#!Blog">Blog</a></li>
				<li ng-hide="currentUser==undefined" ng-show="currentUser.role=='ROLE_USER'||currentUser.role=='ROLE_ADMIN'"> <a href="#!listBlogs"> List Blogs</a></li>				
				<li ng-hide="currentUser==undefined" ng-show="currentUser.role=='ROLE_USER'||currentUser.role=='ROLE_ADMIN'" ><a href="#!Forum">Forum</a>	</li>
				<li ng-hide="currentUser==undefined" ng-show="currentUser.role=='ROLE_USER'||currentUser.role=='ROLE_ADMIN'"><a href="#!displayForum">List Forums</a></li>
				<li  ng-show="currentUser.role=='ROLE_ADMIN'"><a href="#!Job">Job</a></li>
				<li  ng-show="currentUser.role=='ROLE_ADMIN'"><a href="#!displayJob">Job Lists</a></li>	
				...
				<li ng-hide="currentUser==undefined"  ng-show="currentUser.role=='ROLE_USER'"><a href="#!friend">Friends</li>
